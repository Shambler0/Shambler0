...
/** Customizations */
var call_button_text = 'Звонить Марине';      // text showed on call button
var hangup_button_text = 'Завершить звонок';      // text showed on hangup button
...
var button_width = 235;                 // width of button in pixels
var button_height = 82;                 // height of button in pixels
var button_radius = 5;                  // button corner radius in pixels, higher values will result in a round button
var chatwindow_title = 'Текстовые сообщения';          // chat window header-title; can be text or html
